...
def makeplot(key, plaintxt):
    ...
    df = df.T
    plot = df.boxplot()
    plot.set_title("Avalanche effect with different hamming distance",fontweight="bold")
    plot.set_xlabel("Rounds")
    plot.set_ylabel("Hamming Distances")
    print('Distinct Hamming distance')
    print(plot)
...
# plain text with distinct Hamming Distance
plaintxt = ['02468aceeca86420', '02468adeeca86420', '02468adeeca86410', '12468adeeca86410', '12468adeeca86419', '12468adeeaa86419']
